    ...
    <section className={mobileMenu ? "overlay active" : "overlay "}>
        ...
        <div className='sidebar-menu-area'>
          <ul className='sidebar-menu' id='sidebar-menu'>
            ...
            <li>
              <Link
                href='/sermon'
                className={pathname === "/sermon-resources" ? "active-page" : ""}
              >
                <Icon
            ...
            <li>
              <Link
                ...
                className={
                  pathname === "/text-generator-new" ? "active-page" : ""
                }
              >
                <Icon
                  icon='bx:bot'
      ...
      >
        ...
        <footer className='d-footer'>
          <div className='row align-items-center justify-content-between'>
            <div className='col-auto'>
              <p className='mb-0'>© 2025 JTM. All Rights Reserved.</p>
            </div>
            <div className='col-auto'>
              <p className='mb-0'>
                Made by <span className='text-primary-600'>JTM</span>
              </p>
            </div>
          </div>
        </footer>
